<template>
  <!-- Important note:
    This component might change completely, this is just one way of sharing the URL (Engagement info).
    We might want to change this so that you can copy the URL to clipboard instead. -->
  <ul class="underline p-3">
    <li>

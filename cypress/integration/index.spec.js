...
describe('open to the Index page', function() {
  ...
  it('should check footer info for links and canada image', () => {
    ...
    cy.get('#fLinks > :nth-child(3) > a').should('have.attr', 'href', 'https://www.canada.ca/en/government/about.html')
    cy.get('#fLinks > :nth-child(4) > a').should('have.attr', 'href', 'https://www.canada.ca/en/transparency/terms.html')
    cy.get('#fLinks > :nth-child(5) > a').should('have.attr', 'href', 'https://www.canada.ca/en/transparency/privacy.html')
    cy.get('#fLinks > :nth-child(6) > a').should('have.attr', 'href', 'https://home.dts-stn.com/')
